...
$query = "INSERT INTO alunos (nome_aluno, nascimento, bairro) values ('Carla Matos', '2000-03-15','Se'), ('Lucas Seixas', '1997-01-29','Liberdade'), ('Jessica Brito', '1998-02-02','Pinheiros'), ('Victor Silveira', '1996-05-07','Vila Mariana'), ('Luciano Rocha', '1999-07-23','Vila Prudente')";
$execucao = mysqli_query($conexao, $query); 
